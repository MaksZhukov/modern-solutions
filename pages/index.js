        ...
        <>
            ...
            <Container>
                ...
                <div className={styles['prices-info']}>
                    <img className={styles['prices-info__img']} src="price-info.png"></img>
                    <div className={styles['prices-info__desc']}>
                        Конечная стоимость рассчитывается индивидуально. <br />
                        Вы можете оставить заявку на расчет стоимости услуг прямо сейчас, и мы свяжемся с вами для
                        уточнения деталей.
                    </div>
                </div>
                ...
                <Slider
                    ...
                    {clientImages.map((item, index) => (
                        <div key={item.url} className={styles['clients__item']}>
                            <img style={{ height: item.height }} className={styles['clients__img']} src={item.url} />
                        </div>
                    ))}
                </Slider>
            </Container>
