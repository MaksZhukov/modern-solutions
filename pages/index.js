			...
			<Container>
				...
				<div className={styles['stages-of-cooperation']}>
					<div className={styles['stages-of-cooperation__item']}>
						<span className={styles['stages-of-cooperation__num']}>
							1
						</span>
						<div className={styles['stages-of-cooperation__text']}>
							...
							<a
								className={
									styles['stages-of-cooperation__link']
								}
					...
					<div className={styles['stages-of-cooperation__item']}>
						...
						<div className={styles['stages-of-cooperation__text']}>
							Мы проведем комплексный анализ вашей деятельности и
							выявим необходимые доработки.
						</div>
					</div>
					<div className={styles['stages-of-cooperation__item']}>
						<span className={styles['stages-of-cooperation__num']}>
						...
						<div className={styles['stages-of-cooperation__text']}>
							Разработаем техдокументацию, зафиксируем все важные
							для вас параметры.
						</div>
					</div>
					<div className={styles['stages-of-cooperation__item']}>
					...
					<div className={styles['stages-of-cooperation__item']}>
						...
						<div className={styles['stages-of-cooperation__text']}>
							Встраиваем новый функционал в рабочую базу. Проводим
